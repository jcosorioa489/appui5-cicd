		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicación UI5",
									"targetURL": "#cominchcapeappui5cicd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cominchcapeappui5cicd-display": {
								"semanticObject": "cominchcapeappui5cicd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.inchcape.appui5cicd",
									"url": sap.ui.require.toUrl("com/inchcape/appui5cicd")
								}
							}
						}
					}
